...
TRAIN_CLASSES               = "IMAGES/train/class.names"
TRAIN_ANNOT_PATH            = "IMAGES/train/train.txt"
TRAIN_LOGDIR                = "log"
TRAIN_CHECKPOINTS_FOLDER    = "checkpoints/Inc"
#SAVED_MODEL_NAME            = f"{YOLO_TYPE}_custom_horse_deer_penguin_inc"
SAVED_MODEL_NAME            = f"{YOLO_TYPE}_custom_horse_deer"
TRAIN_MODEL_NAME            = f"{YOLO_TYPE}_custom_horse_deer"
...
# TEST options
TEST_ANNOT_PATH             = "IMAGES/test/test.txt"
TEST_BATCH_SIZE             = 4
TEST_INPUT_SIZE             = 416
TEST_DATA_AUG               = False
