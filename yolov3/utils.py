...
def postprocess_boxes(pred_bbox, original_image, input_size, score_threshold):
  ...
  #  print(classes)
    #print(coors.shape, scores.shape, classes.shape)
    return np.concatenate([coors, scores[:, np.newaxis], classes[:, np.newaxis]], axis=-1)


def detect_image(Yolo, image_path, output_path, input_size=416, show=False, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.6, iou_threshold=0.70, rectangle_colors=''):
    ...
    if YOLO_FRAMEWORK == "tf":
       ...
       # print(pred_bbox[0][0][13][13][0][5:])
       # print(pred_bbox[0][0][13][13][1][5:])
       # print(pred_bbox[0][0][13][13][2][5:])
